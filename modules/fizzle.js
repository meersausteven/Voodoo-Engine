...
export class Fizzle {
         ...
         */
        static checkPointInBox(box, point) {
        ...
        calculateCollisions() {
                ...
                while (i < l) {
                        ...
                        const collider = rigidbody.talisman.getEnchantment("Collider");
                        ...
                        if (collider !== false) {
                                ...
                                while (j < k) {
                                        ...
                                        if (otherCollider.talisman === null) {
                                        ...
                                        // only check for collisions with other talismans' colliders
                                        if (rigidbody.talisman !== otherCollider.talisman) {
                                                let collision;
